...
type
  ...
  // Constantes úteis
  COREWEBVIEW2_KEY_EVENT_KIND                           = uWVTypeLibrary.COREWEBVIEW2_KEY_EVENT_KIND;
  COREWEBVIEW2_MOVE_FOCUS_REASON                        = uWVTypeLibrary.COREWEBVIEW2_MOVE_FOCUS_REASON;
  COREWEBVIEW2_WEB_ERROR_STATUS                         = uWVTypeLibrary.COREWEBVIEW2_WEB_ERROR_STATUS;
  COREWEBVIEW2_SCRIPT_DIALOG_KIND                       = uWVTypeLibrary.COREWEBVIEW2_SCRIPT_DIALOG_KIND;
  COREWEBVIEW2_PERMISSION_STATE                         = uWVTypeLibrary.COREWEBVIEW2_PERMISSION_STATE;
  COREWEBVIEW2_PERMISSION_KIND                          = uWVTypeLibrary.COREWEBVIEW2_PERMISSION_KIND;
  COREWEBVIEW2_PROCESS_FAILED_KIND                      = uWVTypeLibrary.COREWEBVIEW2_PROCESS_FAILED_KIND;
  COREWEBVIEW2_CAPTURE_PREVIEW_IMAGE_FORMAT             = uWVTypeLibrary.COREWEBVIEW2_CAPTURE_PREVIEW_IMAGE_FORMAT;
  COREWEBVIEW2_WEB_RESOURCE_CONTEXT                     = uWVTypeLibrary.COREWEBVIEW2_WEB_RESOURCE_CONTEXT;
  COREWEBVIEW2_COOKIE_SAME_SITE_KIND                    = uWVTypeLibrary.COREWEBVIEW2_COOKIE_SAME_SITE_KIND;
  COREWEBVIEW2_HOST_RESOURCE_ACCESS_KIND                = uWVTypeLibrary.COREWEBVIEW2_HOST_RESOURCE_ACCESS_KIND;
