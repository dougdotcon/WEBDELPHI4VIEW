...
type
  ...
  TWVLoader = class(TComponent, IWVLoaderEvents)
    protected
      ...
      procedure doOnGetCustomSchemes(var aSchemeRegistrations : TWVCustomSchemeInfoArray); override;
...
procedure TWVLoader.doOnGetCustomSchemes(var aSchemeRegistrations : TWVCustomSchemeInfoArray);
var
