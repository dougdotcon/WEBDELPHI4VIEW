object MainForm: TMainForm
  ...
  object pnlSolverConfig: TPanel
    ...
    object chkHeadless: TCheckBox
      Left = 8
      Top = 150
      Width = 200
      Height = 17
      Caption = 'Modo Headless (Windowless)'
      TabOrder = 5
    end
    ...
    object btnSolveSonic: TButton
      Left = 24
      Top = 278
      Width = 305
      Height = 25
      Caption = 'Resolver com Sonic'
      TabOrder = 8
      OnClick = btnSolveSonicClick
    end
  end
